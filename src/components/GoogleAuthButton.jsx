...
export default function GoogleAuthButton({ onError }) {
  ...
  return (
    <button
      ...
      disabled={loading}
      className="mt-7 flex min-h-[54px] w-full items-center justify-center gap-3 border border-atelier-ink/20 bg-white px-5 text-[14px] font-bold text-atelier-ink transition hover:border-atelier-ink disabled:cursor-wait disabled:opacity-60"
    >
      <svg viewBox="0 0 24 24" aria-hidden="true" className="h-5 w-5">
        ...
        <path fill="#EA4335" d="M12 5.94c1.47 0 2.78.5 3.82 1.5l2.88-2.88A9.65 9.65 0 0 0 12 2a10 10 0 0 0-8.96 5.45l3.35 2.62C7.18 7.7 9.39 5.94 12 5.94Z" />
      </svg>
